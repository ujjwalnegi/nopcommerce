...
class Test_02_Admin_Login_data_driven():
    ...
    status_list = [] #list type variable - inside this list variable we will maintain the status of all the rows of test data

    def test_valid_admin_login_data_driven(self, setup):
        self.logger.info("************test_admin_login_data_driven*************")
        self.driver = setup
